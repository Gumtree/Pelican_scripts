...
for { set i 1}  {$i <= 8} {incr i} {
	broadcast "Start of 1.5 K lambda Loop: $i"
	histmem start block
...
for { set i 1}  {$i <= 8} {incr i} {
	broadcast "Start of 1.5 K lambda/2 Loop: $i"
	histmem start block
	newfile histogram_xyt
	save
	broadcast "End of Loop: $i, measurement has been running for [expr $i * $meas_time_s / $time_const] hours."
...
for { set i 1}  {$i <= 8} {incr i} {
	broadcast "Start of 20 K lambda Loop: $i"
	histmem start block
	newfile histogram_xyt
	save
	broadcast "End of Loop: $i, measurement has been running for [expr $i * $meas_time_s / $time_const] hours."
...
for { set i 1}  {$i <= 8} {incr i} {
	broadcast "Start of 20 K lambda/2 Loop: $i"
	histmem start block
	newfile histogram_xyt
	save
	broadcast "End of Loop: $i, measurement has been running for [expr $i * $meas_time_s / $time_const] hours."
