...
#hset /sample/tc2/control/ramp_Loop_1 1,2  # turns ramp on
#hset /sample/tc2/control/ramp_Loop_1 0,2  # turns ramp off
...
drive tc2_driveable 410

histmem start block
newfile histogram_xyt
save

drive tc2_driveable 420

histmem start block
newfile histogram_xyt
save

drive tc2_driveable 430

histmem start block
newfile histogram_xyt
save

drive tc2_driveable 440

histmem start block
newfile histogram_xyt
save

drive tc2_driveable 450

histmem start block
newfile histogram_xyt
save

drive tc2_driveable 460

histmem start block
newfile histogram_xyt
save

drive tc2_driveable 470
...
drive tc2_driveable 480

histmem start block
newfile histogram_xyt
save

drive tc2_driveable 490
